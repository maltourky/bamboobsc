...
<body class="flat" bgcolor="#EEEEEE" >
	...
	<table border="0" width="100%" height="50px" cellpadding="1" cellspacing="0" >
		<tr>
    		<td height="25px" width="10%"  align="right"><s:property value="getText('QCHARTS_PROG001D0004Q_id')"/>:</td>
    		...
    		<td height="25px" width="10%"  align="right"><s:property value="getText('QCHARTS_PROG001D0004Q_name')"/>:</td>
    		<td height="25px" width="40%"  align="left">
