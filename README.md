...
https://github.com/billchen198318/bamboobsc/releases/download/v0.6.5.1/bamboobsc-0.6.5.1-VM.7z
<br/>
Manual install version:
https://github.com/billchen198318/bamboobsc/releases/download/v0.6.5.1/bamboobsc-0.6.5.1.7z
<br/><br/>
...
```
# cd /home
# wget --no-check-certificate https://github.com/billchen198318/bamboobsc/releases/download/v0.6.5.1/bamboobsc-0.6.5.1.7z
```
