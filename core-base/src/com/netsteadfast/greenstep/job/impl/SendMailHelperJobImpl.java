...
public class SendMailHelperJobImpl extends BaseJob implements Job {
	...
	public SendMailHelperJobImpl() {
		super();
		sysMailHelperService = (ISysMailHelperService<SysMailHelperVO, TbSysMailHelper, String>)
				AppContext.getBean("core.service.SysMailHelperService");
	}
	...
	private void process(List<TbSysMailHelper> mailHelperList) throws ServiceException, Exception {
		...
		for (TbSysMailHelper mailHelper : mailHelperList) {
			new ProcessWorker(this.sysMailHelperService, mailHelper);
		}
	}
