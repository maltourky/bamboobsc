...
@Controller("core.web.controller.SystemProgramMenuRoleSaveOrUpdateAction")
@Scope
public class SystemProgramMenuRoleSaveOrUpdateAction extends BaseJsonAction {
	private static final long serialVersionUID = -6778049932431021173L;
	protected Logger logger=Logger.getLogger(SystemProgramMenuRoleSaveOrUpdateAction.class);
	private IRoleLogicService roleLogicService;
	private String message = "";
	private String success = IS_NO;
	
	public SystemProgramMenuRoleSaveOrUpdateAction() {
		super();
	}
	...
	private void save() throws ControllerException, AuthorityException, ServiceException, Exception {
		this.checkFields();
		String programOid = this.getFields().get("sysProgOid");
		List<String> roleOidList = super.transformAppendIds2ListByEncode(this.getFields().get("appendRoleOid"));
		DefaultResult<Boolean> result = this.roleLogicService.updateMenuRole(programOid, roleOidList);
