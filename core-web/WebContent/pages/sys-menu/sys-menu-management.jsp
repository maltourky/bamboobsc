	...
	<table border="0" width="750px" height="100px" cellpadding="1" cellspacing="0" >
		<tr>
			<td height="50px" width="100%"  align="center">
				<font size='2'><b><s:property value="getText('CORE_PROG001D0003Q_system')"/>:</b></font>
				<br/>
		...
		<tr>
			<td height="50px" width="100%"  align="center">
				<font size='2'><b><s:property value="getText('CORE_PROG001D0003Q_sysProg')"/>:</b></font>
				<br/>
	...
	<table width="750px" height="160px" border="0" cellpadding="1" cellspacing="0" >
		<tr>
			<td align="center" width="350px" height="200px">
				<b><s:property value="getText('CORE_PROG001D0003Q_enable')"/>:</b>
			...
			<td align="center" width="350px" height="200px">
				<b><s:property value="getText('CORE_PROG001D0003Q_disable')"/>:</b>
