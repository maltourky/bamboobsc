...
<body class="flat" bgcolor="#EEEEEE" >
	...
	<table border="0" width="100%" height="50px" cellpadding="1" cellspacing="0" >
		<tr>
    		<td height="25px" width="10%"  align="right"><s:property value="getText('CORE_PROG001D0012Q_tplId')"/>:</td>
    		...
    		<td height="25px" width="10%"  align="right"><s:property value="getText('CORE_PROG001D0012Q_name')"/>:</td>
