...
var CORE_PROG003D0003A_fieldsId = new Object();
CORE_PROG003D0003A_fieldsId['systemOid'] 		= 'CORE_PROG003D0003A_systemOid';
CORE_PROG003D0003A_fieldsId['beanId'] 			= 'CORE_PROG003D0003A_beanId';
CORE_PROG003D0003A_fieldsId['method'] 			= 'CORE_PROG003D0003A_method';
...
function CORE_PROG003D0003A_clear() {
	...
	dijit.byId('CORE_PROG003D0003A_enableFlag').set("checked", false);		
	dijit.byId('CORE_PROG003D0003A_description').set("value", "");	
}
...
<body class="flat">
	...
	<gs:toolBar
		...
		createNewJsMethod=""		 
		saveEnabel="Y" 
		saveJsMethod="CORE_PROG003D0003A_save();"
		refreshEnable="Y" 		 
	...
	<table border="0" width="100%" height="475px" cellpadding="1" cellspacing="0" >
    	...
    	<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:button name="CORE_PROG003D0003A_save" id="CORE_PROG003D0003A_save" onClick="CORE_PROG003D0003A_save();"
    				handleAs="json"
    				sync="N"
    				xhrUrl="core.systemBeanHelpSaveAction.action"
    				parameterType="postData"
    				xhrParameter=" 
    					{ 
    						'fields.systemOid'		: dijit.byId('CORE_PROG003D0003A_systemOid').get('value'), 
    						'fields.beanId'			: dijit.byId('CORE_PROG003D0003A_beanId').get('value'),
    						'fields.method'			: dijit.byId('CORE_PROG003D0003A_method').get('value'),
    						'fields.enableFlag'		: ( dijit.byId('CORE_PROG003D0003A_enableFlag').checked ? 'true' : 'false' ),
    						'fields.description'	: dijit.byId('CORE_PROG003D0003A_description').get('value')
    					} 
    				"
    				errorFn=""
    				loadFn="CORE_PROG003D0003A_saveSuccess(data);" 
    				programId="${programId}"
    				label="${action.getText('CORE_PROG003D0003A_save')}" 
    				iconClass="dijitIconSave"
    				cssClass="alt-primary"></gs:button>    			
    			<gs:button name="CORE_PROG003D0003A_clear" id="CORE_PROG003D0003A_clear" onClick="CORE_PROG003D0003A_clear();" 
    				label="${action.getText('CORE_PROG003D0003A_clear')}" 
