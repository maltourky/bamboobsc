...
var CORE_PROG001D0013E_fieldsId = new Object();
CORE_PROG001D0013E_fieldsId['templateOid'] 	= 'CORE_PROG001D0013E_templateOid';
CORE_PROG001D0013E_fieldsId['name'] 		= 'CORE_PROG001D0013E_name';
...
<body class="flat">
	...
	<gs:toolBar
		...
		createNewJsMethod=""		 
		saveEnabel="Y" 
		saveJsMethod="CORE_PROG001D0013E_update();"
		refreshEnable="Y" 		 
	...
	<table border="0" width="100%" height="325px" cellpadding="1" cellspacing="0" >
    	...
    	<tr>
    		<td height="50px" width="100%"  align="left">
    			<gs:button name="CORE_PROG001D0013E_update" id="CORE_PROG001D0013E_update" onClick="CORE_PROG001D0013E_update();"
    				handleAs="json"
    				sync="N"
    				xhrUrl="core.systemFormUpdateAction.action"
    				parameterType="postData"
    				xhrParameter=" 
    					{ 
    						'fields.oid'			: '${form.oid}',
    						'fields.formId'			: dijit.byId('CORE_PROG001D0013E_formId').get('value'),
    						'fields.templateOid'	: dijit.byId('CORE_PROG001D0013E_templateOid').get('value'),
    						'fields.name'			: dijit.byId('CORE_PROG001D0013E_name').get('value'),    						
    						'fields.description'	: dijit.byId('CORE_PROG001D0013E_description').get('value')
    					} 
    				"
    				errorFn=""
    				loadFn="CORE_PROG001D0013E_updateSuccess(data);" 
    				programId="${programId}"
    				label="${action.getText('CORE_PROG001D0013E_update')}" 
    				iconClass="dijitIconSave"
    				cssClass="alt-primary"></gs:button>    			
    			<gs:button name="CORE_PROG001D0013E_clear" id="CORE_PROG001D0013E_clear" onClick="CORE_PROG001D0013E_clear();" 
    				label="${action.getText('CORE_PROG001D0013E_clear')}" 
