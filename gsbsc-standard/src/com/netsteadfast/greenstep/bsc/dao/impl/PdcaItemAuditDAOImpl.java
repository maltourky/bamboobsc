...
@Repository("bsc.dao.PdcaItemAuditDAO")
@Scope("prototype")
public class PdcaItemAuditDAOImpl extends BaseDAO<BbPdcaItemAudit, String> implements IPdcaItemAuditDAO<BbPdcaItemAudit, String> {
	
	public PdcaItemAuditDAOImpl() {
		super();
	}
