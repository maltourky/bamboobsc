...
@Repository("bsc.dao.DegreeFeedbackScoreDAO")
@Scope("prototype")
public class DegreeFeedbackScoreDAOImpl extends BaseDAO<BbDegreeFeedbackScore, String> implements IDegreeFeedbackScoreDAO<BbDegreeFeedbackScore, String> {
