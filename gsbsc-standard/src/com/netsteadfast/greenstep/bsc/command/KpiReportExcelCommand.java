...
public class KpiReportExcelCommand extends BaseChainCommandSupport implements Command {
	...
	private int createDateRange(XSSFWorkbook wb, XSSFSheet sh, int row, VisionVO vision, Context context) throws Exception {
		...
		//cellStyleLabel.setVerticalAlignment(XSSFCellStyle.VERTICAL_CENTER);
		cellStyleLabel.setBorderBottom(XSSFCellStyle.BORDER_THIN);
		cellStyleLabel.setBorderTop(XSSFCellStyle.BORDER_THIN);
		cellStyleLabel.setBorderRight(XSSFCellStyle.BORDER_THIN);
		cellStyleLabel.setBorderLeft(XSSFCellStyle.BORDER_THIN);
