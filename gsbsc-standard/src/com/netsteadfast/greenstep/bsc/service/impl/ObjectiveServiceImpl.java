...
@Service("bsc.service.ObjectiveService")
@Scope("prototype")
@Transactional(propagation=Propagation.REQUIRED, readOnly=true)
public class ObjectiveServiceImpl extends BaseService<ObjectiveVO, BbObjective, String> implements IObjectiveService<ObjectiveVO, BbObjective, String> {
	...
	@Required		
	public void setObjectiveDAO(
			IObjectiveDAO<BbObjective, String> objectiveDAO) {
	...
	public String findForMaxObjId(String objId) throws ServiceException, Exception {
		if (StringUtils.isBlank(objId) || !objId.startsWith(BscConstants.HEAD_FOR_OBJ_ID) ) {
	...
	private Map<String, Object> getQueryGridParameter(SearchValue searchValue) throws Exception {
		...
		String objId = searchValue.getParameter().get("objId");
