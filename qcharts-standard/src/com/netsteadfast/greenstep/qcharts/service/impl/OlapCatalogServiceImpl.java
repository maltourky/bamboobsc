...
@Service("qcharts.service.OlapCatalogService")
@Scope("prototype")
@Transactional(propagation=Propagation.REQUIRED, readOnly=true)
public class OlapCatalogServiceImpl extends BaseService<OlapCatalogVO, QcOlapCatalog, String> implements IOlapCatalogService<OlapCatalogVO, QcOlapCatalog, String> {
	protected Logger logger=Logger.getLogger(OlapCatalogServiceImpl.class);
	private IOlapCatalogDAO<QcOlapCatalog, String> olapCatalogDAO;
	
	public OlapCatalogServiceImpl() {
		super();
	}

	public IOlapCatalogDAO<QcOlapCatalog, String> getOlapCatalogDAO() {
		return olapCatalogDAO;
	}

	@Autowired
	@Resource(name="qcharts.dao.OlapCatalogDAO")
	@Required		
	public void setOlapCatalogDAO(
			IOlapCatalogDAO<QcOlapCatalog, String> olapCatalogDAO) {
		this.olapCatalogDAO = olapCatalogDAO;
	}

	@Override
	protected IBaseDAO<QcOlapCatalog, String> getBaseDataAccessObject() {
		return olapCatalogDAO;
	}
